...
abstract class $ApiResultsCopyWith<T, $Res> {
  factory $ApiResultsCopyWith(
      ...
      _$ApiResultsCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$ApiResultsCopyWithImpl<T, $Res>
    implements $ApiResultsCopyWith<T, $Res> {
  _$ApiResultsCopyWithImpl(this._value, this._then);

  final ApiResults<T> _value;
  // ignore: unused_field
  final $Res Function(ApiResults<T>) _then;
}
...
/// @nodoc
class __$$SuccessCopyWithImpl<T, $Res> extends _$ApiResultsCopyWithImpl<T, $Res>
...
/// @nodoc
class __$$FailureCopyWithImpl<T, $Res> extends _$ApiResultsCopyWithImpl<T, $Res>
