...
class _UserListWidgetState extends State<UserListWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      console('refreshing data..........');
      // console(widget.userRolesController.usersList.value);
      return SizedBox(
        // width: sixe.width,
        height: sixe.height,
                        ...
                        child: Column(
                          ...
                          children: [
                            TextFormField(
                              ...
                              onChanged: (value) {
                                widget.userRolesController.searchParam = value;
                                widget.userRolesController.getUsers(context,
                                    endpointName: widget.endpointName,
                                    responseFields: widget.responseFields,
                                    searchKey: value,
                            ...
                            widget.userRolesController.loadingUsers.value
                                ...
                                : SettingsService.use.isEmptyOrNull(widget
                                        ...
                                        !widget.userRolesController.loadingUsers
                                            .value
                                    ? Expanded(
                                        child: GErrorMessage(
                                          icon: const Icon(Icons.error),
                                          ...
                                          buttonLabel: 'Reload',
                                          onPressed: () {
                                            widget.userRolesController.getUsers(
                                                context,
                                                endpointName:
                                                    widget.endpointName,
                                                responseFields:
                                                    widget.responseFields);
                                          },
                                        ),
                                      )
                                    : LayoutBuilder(
                                  ...
                                  children: [
                                    Flexible(
                                      child: ListView.builder(
                                          ...
                                          shrinkWrap: true,
                                          itemCount: widget.userRolesController
                                              .usersList.length,
                                    ...
                                    widget.userRolesController.noMoreData.value
                                        ? Container(
                                            height: 50,
